<template>
  <div class="this flex-0 px-5 py-4 relative">
    <a
      class="
        cursor-pointer
        hover:text-blue-500
    ...
    >
      ...
      <div class="text-xs ml-4 font-medium">
        Referred from <span class="font-bold">GitBook</span>
      </div>
    </a>
  </div>
</template>
...
.this::before
  ...
  width: 100%
  display: block
  background: rgba(0, 0, 0, 0) linear-gradient(rgba(255, 255, 255, 0) 0%, rgb(245, 247, 249) 100%) repeat scroll 0% 0%
</style>
